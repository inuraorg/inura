...
import (
	...
	"github.com/inuraorg/inura/inura-batcher/rpc"
	...
	oprpc "github.com/inuraorg/inura/inura-service/rpc"
...
// and conforms to the inura-service CLI Lifecycle interface.
...
func (bs *BatcherService) Stop(ctx context.Context) error {
	...
	if bs.rpcServer != nil {
		// TODO(7685): the inura-service RPC server is not built on top of inura-service httputil Server, and has poor shutdown
