...
def main():
    ...
    op_node_dir = pjoin(args.monorepo_dir, 'inura-node')
    ...
    ops_chain_ops = pjoin(monorepo_dir, 'inura-chain-ops')
...
def devnet_deploy(paths):
    ...
    log.info('Bringing up `inura-node`, `inura-proposer` and `inura-batcher`.')
    run_command(['docker', 'compose', 'up', '-d', 'inura-node', 'inura-proposer', 'inura-batcher'], cwd=paths.ops_bedrock_dir, env={
        'PWD': paths.ops_bedrock_dir,
