...
```bash
pnpm install @eth-inura/fee-estimation
```

```bash
npm install @eth-inura/fee-estimation
```

```bash
yarn add @eth-inura/fee-estimation
```

### Basic Usage

```ts
import { estimateFees } from '@eth-inura/fee-estimation'
import { optimistABI } from '@eth-inura/contracts-ts'
