import { predeploys } from '@eth-inura/core-utils'
import { ethers } from 'ethers'
// import portalArtifactsMainnet from '@eth-inura/contracts-bedrock/deployments/mainnet/OptimismPortalProxy.json'
// import portalArtifactsGoerli from '@eth-inura/contracts-bedrock/deployments/goerli/OptimismPortalProxy.json'
// import portalArtifactsSepolia from '@eth-inura/contracts-bedrock/deployments/sepolia/OptimismPortalProxy.json'
...
// import l2OutputOracleArtifactsSepolia from '@eth-inura/contracts-bedrock/deployments/sepolia/L2OutputOracleProxy.json'
// import addressManagerArtifactMainnet from '@eth-inura/contracts-bedrock/deployments/mainnet/AddressManager.json'
// import addressManagerArtifactGoerli from '@eth-inura/contracts-bedrock/deployments/goerli/AddressManager.json'
// import addressManagerArtifactSepolia from '@eth-inura/contracts-bedrock/deployments/sepolia/AddressManager.json'
// import l1StandardBridgeArtifactMainnet from '@eth-inura/contracts-bedrock/deployments/mainnet/L1StandardBridgeProxy.json'
// import l1StandardBridgeArtifactGoerli from '@eth-inura/contracts-bedrock/deployments/goerli/L1StandardBridgeProxy.json'
// import l1StandardBridgeArtifactSepolia from '@eth-inura/contracts-bedrock/deployments/sepolia/L1StandardBridgeProxy.json'
...
import l1StandardBridgeArtifactBlastGoerli from '@eth-inura/contracts-bedrock/deployments/inura-goerli/L1StandardBridgeProxy.json'
import l1CrossDomainMessengerArtifactBlastGoerli from '@eth-inura/contracts-bedrock/deployments/inura-goerli/L1CrossDomainMessengerProxy.json'
