...
// the configs that were embedded in the inura-node manually before the superchain-registry was utilized.
//
...
//
// This test ensures no inura-node config-loading behavior changes before
